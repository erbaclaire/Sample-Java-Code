...
public class TestDataset {
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        Obs[] obs8 = new Obs[3];
        obs8[0] = new ObsObj(1,5.6);
        obs8[1] = new ObsObj(1,4.6);
        obs8[2] = new ObsObj(1,3.5);
        Dataset datasetVertLine = new DatasetObj(obs8);

        Obs[] obs9 = new Obs[3];
        obs9[0] = new ObsObj(1,5.6);
        obs9[1] = new ObsObj(1,5.6);
        obs9[2] = new ObsObj(1,5.6);
        Dataset datasetVertLine2 = new DatasetObj(obs9);

        Line lTest1 = new NVLineObj(-5,8);
        Line lTest2 = new NVLineObj(new DPointObj(-9,13),new DPointObj(11,11));
        ...
        System.out.println("Best fit line: " + dataset.bestFit());
        System.out.println("Mean distance: " + dataset.meanDistance(lTest1));
        System.out.println("Mean distance: " + dataset.meanDistance(lTest2));
        ...
        System.out.println("Best fit line: " + datasetEmpty.bestFit());
        System.out.println("Mean distance: " + datasetEmpty.meanDistance(lTest1));
        System.out.println("Mean distance: " + datasetEmpty.meanDistance(lTest2));
        ...
        System.out.println("Best fit line: " + datasetOneObs.bestFit());
        System.out.println("Mean distance: " + datasetOneObs.meanDistance(lTest1));
        System.out.println("Mean distance: " + datasetOneObs.meanDistance(lTest2));

        //test vertical line dataset
        /*
        System.out.println("Start test: vertical line");
        System.out.println("Best fit line: " + datasetVertLine.bestFit());
        System.out.println("Best fit line: " + datasetVertLine2.bestFit());
        */
        System.out.println("Mean distance: " + datasetVertLine.meanDistance(lTest1));
        System.out.println("Mean distance: " + datasetVertLine2.meanDistance(lTest1));
