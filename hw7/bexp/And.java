public class And extends AbstractBExp implements BExp {
    ...
    public String python() {
        return ("(" + this.e1.python() + " and " + this.e2.python() + ")");
    }
    
    public BExp eval() {
        return (this.e1.eval().isTrueConst() && this.e2.eval().isTrueConst()) ? BE.TRUE : BE.FALSE;
    }
